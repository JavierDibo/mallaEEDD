...
template<typename T>
MallaRegular<T>::MallaRegular(int aXMin, int aYMin, int aXMax, int aYMax, int aNDiv) {
    xMin = aXMin;
    yMin = aYMin;
    xMax = aXMax;
    yMax = aYMax;
...
// Devuelve el número máximo de elementos que hay en una casilla de la malla regular
...
// Devuelve el promedio del número de elementos que hay en cada casilla de la malla regular
